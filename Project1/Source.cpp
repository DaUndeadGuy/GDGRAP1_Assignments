...
glm::vec3 translate = glm::vec3(0.0f, 0.0f, 5.f);
...
int main(void)
{
    ...
    Model::Models object("3D/djSword.obj", "Shaders/sample.vert", "Shaders/sample.frag", "Shaders/skybox.vert", "Shaders/skybox.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 projection = glm::perspective(glm::radians(FOV), (height / width), 0.1f, 1000.0f);
