...
void Models::DrawModel(glm::mat4 projection_matrix)
{
    ...
    // Perform linear transformation operations.
    ...
    // Assigns the camera's current view.
    unsigned int viewLoc = glGetUniformLocation(shaderProgram, "view");
    glUniformMatrix4fv(viewLoc, 1, GL_FALSE, glm::value_ptr(view_matrix));

    // Assigns the transformation matrix to the model.
    ...
    // Updates the type of projection we're using.
...
void Models::MoveRight()
{
    this->trans_x -= 0.3f;
}

void Models::MoveLeft()
{
    this->trans_x += 0.3f;
}

void Models::MoveForward()
{
    this->trans_z += 0.3f;
}

void Models::MoveBack()
{
    this->trans_z -= 0.3f;
}

void Models::LookLeft()
{
    this->x_mod -= 1.00f;
}

void Models::LookRight()
{
    this->x_mod += 1.00f;
}
